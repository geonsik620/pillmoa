...
public class PrescriptionHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeButton.setOnClickListener(v -> {
            Intent intent = new Intent(PrescriptionHistoryActivity.this, Main.class);
        ...
        searchHistoryList.add("처방전: 의사 A, 타이레놀 500mg");
        searchHistoryList.add("처방전: 의사 B, 아스피린 100mg");
